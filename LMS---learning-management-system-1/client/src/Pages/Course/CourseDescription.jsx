...
const CourseDescription = () => {
    ...
    return (
        <HomeLayout>
            ...
            <div className="min-h-[90vh] pt-12 px-8 md:px-20 flex flex-col items-center justify-center text-white">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 py-10 relative">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center text-lg md:text-xl justify-between">
